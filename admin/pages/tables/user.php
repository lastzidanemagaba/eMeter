...
<span class="logo-mini"><b>e</b> Meter</span>
  ...
  <aside class="main-sidebar">
    ...
    <?php if($_SESSION['akses']==0){ ?>
      <li class="active">
          <a href="user.php">
            <i class="fa fa-glass"></i> <span>Data Admin</span>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
		    ...
		    <hr></hr>
		  <div align="right">
					<center><button type="button" id="add_button" data-toggle="modal" data-target="#userModal2" class="btn btn-primary btn-sm">Tambah Data</button></center>
				</div>
				<br /><br />
				<table id="user_data2" class="table table-striped table-bordered" style="width:100%">
...
<!-- page script -->
 ...
 <script src="js/demo/userjs.js"></script>
</body>
